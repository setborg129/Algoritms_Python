...
# На время выполнения список и словарь получения по элементам одинаков.

# Удаление элементов из списка при алгоритме удаления
# происходит быстрее, чем удаление из словаря.
